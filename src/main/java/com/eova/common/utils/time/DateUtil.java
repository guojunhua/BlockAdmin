...
public class DateUtil {
	...
	public static long getIntevalDays(Date startDate, Date endDate) {
			...
			return (getIntevalMillis(startDate,endDate) / (1000 * 60 * 60 * 24));

	}
	
	public static long getIntevalMillis(Date startDate, Date endDate) {
    ...
    public static String getDatePoor(Date endDate, Date nowDate)
    {
        ...
        // long ns = 1000;
        // 获得两个时间的毫秒时间差异
        long diff = getIntevalMillis(nowDate,endDate);
        // 计算差多少天
        long day = diff / nd;
        // 计算差多少小时
