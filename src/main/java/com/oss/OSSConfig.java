...
import com.oss.demo.DemoFormController;
import com.oss.demo.DemoIconController;
import com.oss.demo.DemoModalController;
import com.oss.demo.DemoOperateController;
import com.oss.demo.DemoReportController;
import com.oss.demo.DemoTableController;
...
public class OSSConfig extends EovaConfig {
 ...
 //       me.add("/user", UserController.class);
        ...
        me.add("/demo/form", DemoFormController.class);
        me.add("/demo/table", DemoTableController.class);
        me.add("/demo/modal", DemoModalController.class);
        me.add("/demo/operate", DemoOperateController.class);
        me.add("/demo/report", DemoReportController.class);
        me.add("/demo/icon", DemoIconController.class);
       // LoginInterceptor.excludes.add("/demo/form");
    }
...
//        arp.addMapping("orders", Orders.class);
        ...
        //演示绑定自有user表
        	arp.addMapping("t_user", com.eova.model.UserInfo.class);
    }
