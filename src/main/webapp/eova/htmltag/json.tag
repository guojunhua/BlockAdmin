...
<input type="hidden" name="${name!}" value='' id="hidden_${id!}" />
<textarea style="display:none" id="hidden2_${id!}" >${value!}</textarea>
<script type="text/javascript">
$(function(){
	
	var datason = $('#hidden2_${id!}').val();
	$("#hidden_${id!}").val($.jsonformat(datason,true));
    if(datason != '') {
