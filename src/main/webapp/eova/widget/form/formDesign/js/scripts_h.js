...
//						readOnly = true;
					...
					console.log(name+',列宽:'+columnWidth+" 对象："+one );
					
					//{defaultVal:defaultValue,placeholder:placeholder,verify:layVerify,readOnly:readOnly,ismust:isMust};
					oneFiled.name = name;
					oneFiled.explain = explain;
					
					oneFiled.id = id;
					oneFiled.defaultVal = one.defaultVal;
					oneFiled.placeholder = one.placeholder;
					oneFiled.verify = one.verify;
					oneFiled.ismust = one.ismust;
					
					oneFiled.readOnly = one.readOnly;
