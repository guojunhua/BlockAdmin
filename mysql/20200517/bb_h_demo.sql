...
INSERT INTO `demo2_test` VALUES (59, '照5', 0, '18014700005', '<p>123123123123123123123123123123</p><p>123123123123123123123123123123</p><p>123123123123123123123123123123<br></p>', '2020-03-25 21:48:00', '2020-04-13 18:29:10', '0,1,2,3', '1', '123456', 'http://img.bblocks.cn/92f9b1690e374fb6a33b8253e3ea3b72.jpg', 'http://img.bblocks.cn/4990ef4237ec433bbdd8a315efe5edea.zip', 4, 1, 19, 20, 27, 1, 1, 72, '首页.zip', 'fa fa-anchor');
INSERT INTO `demo2_test` VALUES (60, '照6', 0, '18014700006', '<p>66666666</p><p>7777777</p><p>888888</p><p>999999</p>', '2020-03-29 00:53:36', '2020-05-22 19:12:08', '1,2', '3', '123456', 'http://img.bblocks.cn/27fbae91780d4a9492a46dfac26d8948.jpg', 'http://img.bblocks.cn/faa519647e3340cf8ad97e36148d8ddd.pdf', 2226, 1, 810, 811, 820, 1, 1, 71, '000000.pdf', 'fa fa-calendar-check-o');
...
INSERT INTO `demo2_test` VALUES (64, '赵金0529', 1, '18014700788', '<p>杀杀杀</p>', '2020-05-29 14:17:17', '2020-05-29 14:17:17', '1,2', '2', '111111', 'http://img.bblocks.cn/4c2c8fd5875b4c2290b3da80723a6b3c.png', 'http://img.bblocks.cn/4dd54af565254984b9dede56e4290315.png', 2229, 0, 1, 2, 3, 1, 1, 55, 'b2.png', 'fa fa-adjust');
...
CREATE TABLE `dicts`  (
  ...
  `field` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '字段名',
  `ext` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '扩展Json',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `IND_D_OANDF`(`object`, `field`) USING BTREE
...
INSERT INTO `dicts` VALUES (282, '1', '男', 'demo2_test', 'Sexy', '');
INSERT INTO `dicts` VALUES (283, '0', '女', 'demo2_test', 'Sexy', '');
INSERT INTO `dicts` VALUES (284, '1', '未审核', 'demo2_test', 'shenhe_status', '');
INSERT INTO `dicts` VALUES (285, '2', '审核通过', 'demo2_test', 'shenhe_status', '');
INSERT INTO `dicts` VALUES (286, '3', '驳回', 'demo2_test', 'shenhe_status', '');
INSERT INTO `dicts` VALUES (302, '0', '初始', 't_notice', 'status', '');
INSERT INTO `dicts` VALUES (303, '1', '审核通过', 't_notice', 'status', '');
INSERT INTO `dicts` VALUES (304, '2', '驳回', 't_notice', 'status', '');
INSERT INTO `dicts` VALUES (308, '1', '黑色', 't_notice', 'color', '');
INSERT INTO `dicts` VALUES (309, '2', '红色', 't_notice', 'color', '');
INSERT INTO `dicts` VALUES (310, '1', '部门内', 't_notice', 'type', '');
INSERT INTO `dicts` VALUES (311, '2', '公司内', 't_notice', 'type', '');
INSERT INTO `dicts` VALUES (312, '3', '对外', 't_notice', 'type', '');
INSERT INTO `dicts` VALUES (313, '0', '拒绝', 't_notice_oa', 'status', '');
INSERT INTO `dicts` VALUES (314, '1', '同意', 't_notice_oa', 'status', '');
INSERT INTO `dicts` VALUES (315, '2', '终止', 't_notice_oa', 'status', '');
INSERT INTO `dicts` VALUES (316, '-1', '审核中', 't_notice_oa', 'status', '');
...
CREATE TABLE `hotel`  (
  ...
  `province_id` int(11)  COMMENT '省',
  `city_id` int(11)   COMMENT '市',
  `region_id` int(11)   COMMENT '区',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '酒店' ROW_FORMAT = Dynamic;
...
INSERT INTO `hotel` VALUES (16, 'XX酒店', '022-345678', 'xx路1号', 1, 0, '2020-04-13 21:33:16', 464, 513, 519);
INSERT INTO `hotel` VALUES (17, '有家酒店', '112', 'xxx路1号', 1, 100, '2020-05-29 14:16:11', 19, 20, 31);
...
INSERT INTO `hotel_bed` VALUES (25, 10, 2, 1);
INSERT INTO `hotel_bed` VALUES (26, 10, 4, 180);
...
INSERT INTO `sale_data` VALUES (54, 28, '照', 0, 54, 0.00);
INSERT INTO `sale_data` VALUES (55, 1, 'ip9', 100, 54, 20.00);
INSERT INTO `sale_data` VALUES (56, 1, 'ip9', 100, 54, 22.00);
INSERT INTO `sale_data` VALUES (57, 33, '1212', 12, 54, 0.00);
...
-- ----------------------------
DROP TABLE IF EXISTS `t_dd_cfg`;
CREATE TABLE `t_dd_cfg`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `org_name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '机构名',
  `org_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '机构ID（直接管理部门表_customer_id）',
  `agent_id` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '钉钉机构ID',
  `app_key` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '钉钉KEY',
  `app_secret` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '钉钉密钥',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '钉钉渠道配置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_dd_cfg
-- ----------------------------
INSERT INTO `t_dd_cfg` VALUES (1, '积木组织', '1', '757539247', 'dinghevmsqhtf0n8zngl', 'JRIOAPNaipp99JglZUkoTg_KwvoYn5JGM9CxA_TmbKJ8X4aA4kc5IF9c3v43piPl');
...
CREATE TABLE `t_department`  (
  ...
  `third_id` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '外部ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 87 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '部门表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_department
-- ----------------------------
INSERT INTO `t_department` VALUES (3, '商务部', 0, 1, NULL, 1, NULL, '赵3', NULL);
INSERT INTO `t_department` VALUES (5, '南京分公司', 0, 1, NULL, 1, NULL, '赵5', NULL);
INSERT INTO `t_department` VALUES (9, '财务部', 0, 1, NULL, 6, NULL, '赵9', NULL);
INSERT INTO `t_department` VALUES (10, '运输部', 0, 1, NULL, 6, NULL, '赵10', NULL);
INSERT INTO `t_department` VALUES (12, '财务子部门1', 0, 1, NULL, 4, NULL, '赵41', NULL);
INSERT INTO `t_department` VALUES (13, '财务子子', 0, 1, NULL, 12, NULL, '赵411', NULL);
INSERT INTO `t_department` VALUES (14, '财务子子子1', 0, 1, NULL, 13, NULL, '找找', NULL);
INSERT INTO `t_department` VALUES (15, '财务子子子2', 0, 1, NULL, 13, NULL, '找找找2', NULL);
INSERT INTO `t_department` VALUES (17, '创新部', 1, NULL, NULL, 6, NULL, '111', NULL);
INSERT INTO `t_department` VALUES (18, '运输部2', 1, NULL, NULL, 10, NULL, '老王', NULL);
INSERT INTO `t_department` VALUES (19, '1', 1, NULL, NULL, 18, NULL, '1', NULL);
INSERT INTO `t_department` VALUES (20, '运营部', 1, NULL, NULL, 6, NULL, 'Lucky', NULL);
INSERT INTO `t_department` VALUES (21, '反根倒舌', 1, NULL, NULL, 10, NULL, '', NULL);
INSERT INTO `t_department` VALUES (22, 'AAA', 1, NULL, NULL, 10, NULL, '', NULL);
INSERT INTO `t_department` VALUES (23, 'ertet', 1, NULL, NULL, 9, NULL, 'rf', NULL);
INSERT INTO `t_department` VALUES (24, 'wefwfAFE', 1, NULL, NULL, 17, NULL, 'sfsdafwef', NULL);
INSERT INTO `t_department` VALUES (25, 'test', 1, NULL, NULL, 12, NULL, '', NULL);
INSERT INTO `t_department` VALUES (26, 'test1', 1, NULL, NULL, 25, NULL, '', NULL);
INSERT INTO `t_department` VALUES (29, '阿迪发动', 1, NULL, NULL, 25, NULL, '调度', NULL);
INSERT INTO `t_department` VALUES (30, '0', 1, NULL, NULL, 3, NULL, '0', NULL);
INSERT INTO `t_department` VALUES (31, '1212', 1, NULL, NULL, 28, NULL, '21', NULL);
INSERT INTO `t_department` VALUES (32, '3123', 1, NULL, NULL, 28, NULL, '3123', NULL);
INSERT INTO `t_department` VALUES (33, '1', 1, NULL, NULL, 30, NULL, '', NULL);
INSERT INTO `t_department` VALUES (34, '111', 1, NULL, NULL, 33, NULL, '222', NULL);
INSERT INTO `t_department` VALUES (35, 'ccfxzcxzcxz', 1, NULL, NULL, 2, NULL, '', NULL);
INSERT INTO `t_department` VALUES (36, '21212', 1, NULL, NULL, 33, NULL, '', NULL);
INSERT INTO `t_department` VALUES (37, '123', 1, NULL, NULL, 5, NULL, '123', NULL);
INSERT INTO `t_department` VALUES (38, '111', 1, NULL, NULL, 30, NULL, '', NULL);
INSERT INTO `t_department` VALUES (39, '3233', 0, NULL, NULL, 222, NULL, '22', NULL);
INSERT INTO `t_department` VALUES (40, '1', 1, NULL, NULL, 30, NULL, '', NULL);
INSERT INTO `t_department` VALUES (41, '1', 1, NULL, NULL, 5, NULL, '1', NULL);
INSERT INTO `t_department` VALUES (42, '33', 1, NULL, NULL, 40, NULL, '', NULL);
INSERT INTO `t_department` VALUES (43, '6', 1, NULL, NULL, 5, NULL, '6', NULL);
INSERT INTO `t_department` VALUES (44, '31', 1, NULL, NULL, 3, NULL, '', NULL);
INSERT INTO `t_department` VALUES (45, 'lol', 1, NULL, NULL, 42, NULL, 'l', NULL);
INSERT INTO `t_department` VALUES (46, 'java', 1, NULL, NULL, 43, NULL, 'dd', NULL);
INSERT INTO `t_department` VALUES (47, 'jd', 1, NULL, NULL, 37, NULL, 'dd', NULL);
INSERT INTO `t_department` VALUES (48, 'ss', 1, NULL, NULL, 47, NULL, 'adsa', NULL);
INSERT INTO `t_department` VALUES (49, 'fdss', 1, NULL, NULL, 47, NULL, 'dfsfd', NULL);
INSERT INTO `t_department` VALUES (50, 'zzt', 1, NULL, NULL, 41, NULL, '', NULL);
INSERT INTO `t_department` VALUES (51, '技术部', 1, NULL, NULL, 2, NULL, '赵1', NULL);
INSERT INTO `t_department` VALUES (52, '技术部2', 1, NULL, NULL, 2, NULL, '事实上', NULL);
INSERT INTO `t_department` VALUES (53, '部门2', 1, NULL, NULL, 2, NULL, '22', NULL);
INSERT INTO `t_department` VALUES (54, 'XX总公司', 1, 1, 1, 0, NULL, '22', NULL);
INSERT INTO `t_department` VALUES (55, '南京分公司', 1, 1, 55, 54, NULL, '赵3', NULL);
INSERT INTO `t_department` VALUES (71, '技术部', 1, 1, NULL, 55, NULL, '122', NULL);
INSERT INTO `t_department` VALUES (75, '234567890', 1, 1, 55, 55, NULL, NULL, NULL);
INSERT INTO `t_department` VALUES (76, '123', 1, 1, 55, 55, NULL, NULL, NULL);
INSERT INTO `t_department` VALUES (77, '北京分公司', 1, 1, 67, 54, NULL, NULL, NULL);
INSERT INTO `t_department` VALUES (78, '技术二部', 1, 1, 65, 77, NULL, NULL, NULL);
INSERT INTO `t_department` VALUES (79, '积木团队', 1, 10, NULL, 0, NULL, NULL, '1');
INSERT INTO `t_department` VALUES (80, '南京支部', 1, 10, NULL, 79, NULL, NULL, '345465347');
INSERT INTO `t_department` VALUES (81, '二号工厂', 1, 10, NULL, 80, NULL, NULL, '345555383');
INSERT INTO `t_department` VALUES (82, '一号工厂', 1, 10, NULL, 80, NULL, NULL, '345639347');
INSERT INTO `t_department` VALUES (83, '财务', 1, 10, NULL, 86, NULL, NULL, '345697353');
INSERT INTO `t_department` VALUES (84, '技术', 1, 10, NULL, 86, NULL, NULL, '345823297');
INSERT INTO `t_department` VALUES (85, '市场', 1, 10, NULL, 86, NULL, NULL, '345906396');
INSERT INTO `t_department` VALUES (86, '北京支部', 1, 10, NULL, 79, NULL, NULL, '345940325');
...
CREATE TABLE `t_notice`  (
  ...
  `type` tinyint(4) NULL DEFAULT NULL COMMENT '类型:1=部门内,2=公司内,3=对外',
  `create_user` int(11) NULL DEFAULT NULL COMMENT '创建人',
...
INSERT INTO `t_notice` VALUES (70, '小发一个公告', '公告小测试拉~\r\n感谢各位~', NULL, 1, NULL, NULL, '2020-05-07 20:39:11', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (71, '一个小部门公告', '一个小部门公告，啦啦啦~~', NULL, 1, NULL, NULL, '2020-05-08 00:17:00', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (72, '二个小公告', '一个小部门公告', NULL, 1, NULL, NULL, '2020-05-08 00:20:48', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (73, '二个小公告', '一个小部门公告', NULL, 1, NULL, NULL, '2020-05-08 00:22:51', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (74, '三个小公告', '二个小公告拉拉~~', NULL, 2, NULL, NULL, '2020-05-08 09:20:38', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (75, '三个小公告', '二个小公告拉拉~~', NULL, 2, NULL, NULL, '2020-05-08 09:28:18', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (76, '三个小公告', '二个小公告拉拉~~', NULL, 2, NULL, NULL, '2020-05-08 09:29:08', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (77, '三个小公告', '三个小公告啦啦啦~~', NULL, 2, NULL, NULL, '2020-05-08 09:33:07', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (78, '三个小公告', '三个小公告啦啦啦~~', NULL, 2, NULL, NULL, '2020-05-08 09:38:04', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (79, '三个小公告', '三个小公告。。。', NULL, 2, NULL, NULL, '2020-05-08 09:39:23', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (80, '三个小公告', '三个小公告啦啦啦~~', NULL, 1, NULL, NULL, '2020-05-08 09:46:24', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES
NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (155, '64', '64', 0, 2, 1, NULL, '2020-05-10 20:58:28', NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (156, '64', '64', 0, 2, 1, NULL, '2020-05-10 21:00:34', NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (157, '64', '64', 0, 2, 1, NULL, '2020-05-10 21:00:52', NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (158, '64', '64', 0, 2, 1, NULL, '2020-05-10 21:03:34', NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (160, '第55个小公告', '第55个小公告~~', 0, 2, 1, NULL, '2020-05-10 21:09:43', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (161, '第56个小公告', '第56个小公告~~~', 0, 2, 1, NULL, '2020-05-10 21:10:25', NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (162, '第57个小公告', '第57个小公告	~~', 0, 2, 1, NULL, '2020-05-10 21:11:16', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (163, '第58个小公告', '第58个小公告	~~', 0, 2, 1, NULL, '2020-05-10 21:11:28', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (164, '第59个小公告', '第59个小公告	~~', 0, 2, 75, NULL, '2020-05-10 21:12:10', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (165, '第60个小公告', '第60个小公告	~~', NULL, 2, 75, NULL, '2020-05-10 21:12:24', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (166, '60', '60', 0, 2, 75, NULL, '2020-05-10 21:20:48', NULL, NULL, NULL);
INSERT INTO `t_notice` VALUES (167, '60', '60', 0, 1, 75, 75, '2020-05-10 21:21:24', '2020-05-11 10:49:46', NULL, 'no can');
INSERT INTO `t_notice` VALUES (168, '第61个小公告', '第61个小公告', NULL, 2, 75, 75, '2020-05-11 10:42:08', NULL, 1, NULL);
INSERT INTO `t_notice` VALUES (169, '第62个小公告', '第62个小公告', 1, 2, 75, 75, '2020-05-11 10:43:24', '2020-05-11 10:48:37', 2, '放你一马');
INSERT INTO `t_notice` VALUES (170, '第63个小公告', '第63个小公告!!!', NULL, 3, 1, 75, '2020-05-11 21:57:09', NULL, 2, 'ok');
INSERT INTO `t_notice` VALUES (171, '第64个小公告', '第64个小公告', NULL, 3, 75, 75, '2020-05-11 22:07:51', NULL, 2, 'ok[张妍](0344561953777837)');
INSERT INTO `t_notice` VALUES (172, '第65个小公告', '第65个小公告~~~', 1, 3, 75, 78, '2020-05-11 22:45:23', '2020-05-11 23:05:31', 2, '同意');
INSERT INTO `t_notice` VALUES (173, '第66个小公告', '第66个小公告', NULL, 3, 75, NULL, '2020-05-11 23:51:32', NULL, 2, NULL);
INSERT INTO `t_notice` VALUES (174, '第67个小公告', '第67个小公告!!', 1, 3, 75, 76, '2020-05-11 23:54:18', '2020-05-12 14:30:38', 2, 'OK');
INSERT INTO `t_notice` VALUES (175, '第68个小公告', '第68个小公告	!!', 1, 2, 1, 79, '2020-05-12 21:22:58', '2020-05-12 21:33:03', 2, '好的\n\n');
INSERT INTO `t_notice` VALUES (176, '第69个小公告	!!', '第68个小公告	!!!', 0, 3, 75, 75, '2020-05-12 21:24:15', '2020-05-12 21:26:27', 2, '不行');
...
CREATE TABLE `t_product`  (
  ...
  `user_id` int(11) NOT NULL COMMENT '填表人',
  `by_date` datetime NULL DEFAULT NULL COMMENT '填表日期',
...
CREATE TABLE `t_user`  (
  ...
  `rid` int(11) NULL DEFAULT NULL COMMENT '角色（存第一角色iD）',
  ...
  `third_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '第三方ID(目前是钉钉)',
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES (1, 1, 'bb', '我就是超管', '2019-01-02 19:16:05', '', '', 1, '1', 0, 54, 'http://img.bblocks.cn/0f3fb1f7ce694a648c243819e36a3db6.jpg', 'jzhao12@qq.com', '18014700912', 2, NULL, 10);
INSERT INTO `t_user` VALUES (50, 0, 'ssr111', '111', '2018-08-01 00:00:00', '111', '1111', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (51, 0, '2222222222222', '', '2018-08-18 16:18:40', '1111111111', '222222222', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (52, 0, '', '', '2018-11-02 23:38:55', '', '', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (55, 1, 'jzhao', '赵金', '2018-11-18 18:04:38', '', '', 2, '2', 1, 74, 'http://img.bblocks.cn/3baa5eecf38346d3aa763498b80215b8.jpg', 'balance_jin@qq.com', '18014700000', 1, NULL, NULL);
INSERT INTO `t_user` VALUES (56, 0, 'jzhao3', 'zhaojin3', '2018-11-18 18:07:56', '', '', 2, '2', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (58, 1, 'jzhao6', '赵金6', '2018-11-18 19:46:11', '', '', 2, '2', 0, 68, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (59, 1, 'jzhao7', '赵金7', '2018-11-18 19:46:42', '', '', 2, '2', 0, 55, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (60, 1, 'jzhao8', '赵金8', '2018-11-18 19:48:06', '', '', 8, '8,9', 0, 54, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (62, 1, 'jzhao9', 'jin9', '2019-01-02 19:36:01', '', '', 2, '2', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (63, 1, 'jzhao10', '', '2019-01-02 19:43:05', '', '', 3, '3', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (64, 1, 'qqq', 'qqq', '2019-01-03 14:59:39', 'qqq', 'qqq', 7, '7', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (65, 1, '1212', '12121', '2019-01-03 15:00:05', '212121', '221212121', 2, '2', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (66, 1, 'zj65', '', '2019-06-05 17:38:25', '', '', 2, '2', 1, 55, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (68, 1, 'ds', 'sd', '2019-07-11 21:52:46', '', '', 2, '2', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (69, 1, 'jzhao101', 'kin', '2020-04-03 10:39:38', '测试用账户', '', 7, '7', 0, 72, 'http://img.bblocks.cn/b27ac90a8fef4ec6af111bd0e07a0f2f.jpg', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `t_user` VALUES (75, 1, '18014700700', '赵金', '2020-05-12 22:59:53', '来源钉钉', '', 291, '291', 0, 79, NULL, NULL, '18014700700', 1, 'manager3361', 10);
INSERT INTO `t_user` VALUES (76, 1, '13962239800', '闫旬俭', '2020-05-12 22:59:55', '来源钉钉', '', NULL, NULL, 0, 82, NULL, NULL, '13962239800', 1, '064138264437711532', 10);
INSERT INTO `t_user` VALUES (77, 1, '13381268800', '刘文强', '2020-05-12 22:59:55', '来源钉钉', '', NULL, NULL, 0, 81, NULL, NULL, '13381268800', 1, '041401541021026475', 10);
INSERT INTO `t_user` VALUES (78, 1, '13977377800', '蒋培明', '2020-05-12 22:59:54', '来源钉钉', '', NULL, NULL, 0, 79, NULL, NULL, '13977377800', 1, '106812570333331968', 10);
INSERT INTO `t_user` VALUES (79, 1, '17384403900', '张妍', '2020-05-12 22:59:54', '来源钉钉', '', NULL, NULL, 0, 80, NULL, NULL, '17384403900', 1, '0344561953777837', 10);
...
CREATE TABLE `test_info`  (
  ...
  `test7` datetime NULL DEFAULT NULL COMMENT 'datetime',
  PRIMARY KEY (`id`) USING BTREE
